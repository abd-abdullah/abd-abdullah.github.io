	...
	data: () => {
		return {
			contacts: [
				{
					id: 1,
					name: 'House 01, Road 08, Sector 09, Dhaka-1230, Bangladesh',
					icon: 'map-pin',
				},
				{
					id: 2,
					name: 'abdullah001rti@gmail.com',
					icon: 'mail',
				},
				{
					id: 3,
...
<template>
	<div
        class="max-w-screen-lg p-3 mx-auto my-auto bg-gray-100 border-4 border-gray-700 print:border-0 page print:max-w-letter print:max-h-letter print:mx-0 print:my-o lg:h-letter md:max-w-letter md:h-letter xsm:p-8 sm:p-9 md:p-16 lg:mt-6 rounded-2xl print:bg-white"
      >
        <!-- Name ---------------------------------------------------------------------------------------------------->
        <header
          class="inline-flex items-baseline justify-between w-full mb-3 align-top border-b-8"
        >
          <div class="block">
            ...
            <h3
              class="m-0 mt-2 ml-2 font-semibold text-md text-gray-550 leading-snugish"
            >
            ...
            <div class="break-inside-avoid">
              ...
              <section class="mb-2 break-inside-avoid">
                ...
                <div class="my-1 last:pb-1">
                  <ul
                    class="flex flex-wrap text-sm2 leading-relaxed -mr-1.6 -mb-1"
                  >
                    <li
                      class="px-2.5 mr-1.6 mb-1 text-gray-200 leading-relaxed print:bg-white print:border-inset bg-gray-250"
                    >
                      HTML5
                    </li>
                    <li
              ...
              <section class="mb-2 break-inside-avoid">
                <header>
                  <h3
                    class="font-semibold text-gray-700 text-m leading-snugish"
                  >
                    DevOps
                  </h3>
                </header>
