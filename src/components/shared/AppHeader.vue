	...
	<nav id="nav" class="sm:container sm:mx-auto">
		...
		<div class="z-10 max-w-screen-lg xl:max-w-screen-xl block sm:flex sm:justify-between sm:items-center my-6">
			...
			<div class="flex justify-between items-center px-4 sm:px-0">
				...
				<div>
					<router-link to="/">
						<img v-if="theme === 'light'" src="@/assets/images/logo-dark.png" class="w-36" alt="Dark Logo" />
						<img v-else src="@/assets/images/logo-light.png" class="w-36" alt="Light Logo" />
					</router-link>
				</div>
			...
			<div class="hidden sm:flex justify-between items-center flex-col md:flex-row">
				...
				<div class="hidden md:block">
					<Button title="Hire Me" class="text-md font-general-medium bg-indigo-500 hover:bg-indigo-600 text-white shadow-sm rounded-md px-5 py-2.5 duration-300" @click="showModal()" aria-label="Hire Me Button" />
				</div>
